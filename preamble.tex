...
\lstnewenvironment{ccodelisting}{\lstset{style=cheri,language=C}}{}
\lstnewenvironment{llvmlisting}{\lstset{language={llvm}}}{}
\newcommand{\ccode}[1]{\lstinline[style=cheri,backgroundcolor=\color{white},language=C]|#1|}
\newcommand{\llvmir}[1]{\lstinline[style=cheri,backgroundcolor=\color{white},language={llvm}]|#1|}
\newcommand{\asm}[1]{\lstinline[style=cheri,backgroundcolor=\color{white},language={}]|#1|}
\lstnewenvironment{asmcode}{\lstset{style=cheri,language=}}{}
