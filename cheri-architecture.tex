...
Pseudocode is derived from the Sail
CHERI-RISC-V model, with the following license:
\begin{footnotesize}
\lstinputlisting[style=license]{sail_latex_riscv/LICENCE.sail-cheri-riscv}
\end{footnotesize}

That Sail model is, in turn, derived from the RISC-V model, with the following
license:
\begin{footnotesize}
\lstinputlisting[style=license]{sail_latex_riscv/LICENCE.sail-riscv}
\end{footnotesize}
